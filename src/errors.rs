...
pub const ERR_03_NOT_RUN_OUT: &str = "ERROR_03: Red packet does not run out";
...
pub const ERR_21_ACCOUNT_NOT_REGISTERED: &str = "ERROR_21: Account is not registered";
pub const ERR_22_NOT_ENOUGH_STORAGE_BALANCE: &str = "ERROR_22: Not enough storage balance";
pub const ERR_23_ACCOUNT_ALREADY_REGISTERED: &str = "ERROR_23: Account is already registered";
